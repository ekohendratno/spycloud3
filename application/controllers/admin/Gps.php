...
class Gps extends CI_Controller{
	...
	function index(){
        ...
        $this->template->load('template','admin/gps',$data);
	}
	...
	function cobaQuery($params = array()){
		...
		$data = array();
		$commands = $this->db->select('*')->from('gps');
		...
		foreach ($commands->result_array() as $row){
			$baris['gps_id'] = $row['gps_id'];
			$baris['coordinat'] = $row['coordinat'];
	...
	function ajaxPaginationData(){
        ...
        $config['base_url']    = base_url().'gps/ajaxPaginationData';
	...
	function hapusdatabyid(){
		...
		$this->m->hapusbyid(array('gps_id'=>$id),'gps');
