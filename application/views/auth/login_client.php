...
<head>
    ...
    <title>USBKA - Ujian Sekolah Berbasis Komputer dan Android</title>
...
<div class="container-full">
    <header>
        <div class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3">
            ...
            <h2 class="text-light text-left">USBKA</h2>
            <h4 class="pt-2 text-left">Ujian Sekolah Berbasis Komputer dan Android</h4>
        </div>
    </header>
    <main class="content">
