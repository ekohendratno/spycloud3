<div class="container container-medium">
            ...
            <div class="col-md-12">
				<div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title text-center" style="padding-top: 7.5px;">CONTACT</h4>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?php echo base_url(). "admin/contact/index"; ?>" class="btn btn-primary">Show All</a>
                                            </div>
	...
	<script type="text/javascript">
		...
		function searchFilter(page_num) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>index.php/admin/contact/ajaxPaginationData/'+page_num,
		...
		function paginationData(data) {
			...
			for(emp in data){
				...
				var empRow = '<tr>'+
                            ...
                            '<span class="label label-success">'+data[emp].contact_name+'</span><br>'+
							'<span class="label label-danger">'+data[emp].contact_phone+'</span></td>'+
							'<td class="text-center"><div class="btn-group" role="group"><a onclick="hapus('+data[emp].contacts_id+')" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span></a></div></td>'+
							+'</tr>';
				nomor++;
		...
		function hapus(x){
			...
			if(tanya){
				...
				type:'POST',
				data: 'id='+x,
				url:'<?php echo base_url('index.php/admin/contact/hapusdatabyid') ;?>',
				success: function(){					
					searchFilter(0);
				}
			});
